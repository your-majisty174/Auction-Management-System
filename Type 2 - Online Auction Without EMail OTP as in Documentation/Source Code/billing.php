...
if(isset($_POST['submit']))
{
	...
	{
		$sql = "INSERT INTO  billing (purchase_date,purchase_amount,payment_type,card_type,card_number,expire_date,cvv_number,card_holder,note,status,customer_id,product_id) VALUES('$dt','100','Sell','$_POST[payment_type]','$_POST[card_number]','$_POST[expire_date]-01','$_POST[cvv_number]','$_POST[card_holder]','$_POST[note]','Active','$_SESSION[customer_id]','$_GET[productid]')";
		$qsql = mysqli_query($con,$sql);
			echo mysqli_error($con);
		if(mysqli_affected_rows($con) == 1)
		{
