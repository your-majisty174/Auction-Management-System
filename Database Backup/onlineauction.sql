...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 23, 2022 at 06:57 PM
...
CREATE TABLE `bidding` (
  ...
  `bidding_amount` float(10,2) NOT NULL DEFAULT 0.00,
  `bidding_date_time` datetime DEFAULT NULL,
...
CREATE TABLE `billing` (
  ...
  `purchase_amount` float(10,2) NOT NULL DEFAULT 0.00,
...
CREATE TABLE `payment` (
  ...
  `product_id` int(10) NOT NULL DEFAULT 0,
  `bidding_id` int(10) NOT NULL DEFAULT 0,
...
CREATE TABLE `product` (
  ...
  `starting_bid` float(10,2) NOT NULL DEFAULT 0.00,
  `ending_bid` float(10,2) NOT NULL DEFAULT 0.00,
  `start_date_time` datetime NOT NULL DEFAULT current_timestamp(),
  `end_date_time` datetime NOT NULL DEFAULT current_timestamp(),
  `product_cost` float(10,2) NOT NULL DEFAULT 0.00,
...
CREATE TABLE `winners` (
  ...
  `product_id` int(10) NOT NULL DEFAULT 0,
  `customer_id` int(10) NOT NULL DEFAULT 0,
  `winners_image` varchar(100) DEFAULT NULL,
  `winning_bid` float(10,2) NOT NULL DEFAULT 0.00,
